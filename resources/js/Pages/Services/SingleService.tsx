            ...
            <Container>
               ...
               <div className="flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-24">
                  ...
                  <div className="basis-2/4">
                     ...
                     <p
                        className="text-[#363636] text-sm 2xl:text-[1.063rem] mb-5"
                        dangerouslySetInnerHTML={{ __html: service.description || '' }}
                     />
                  </div>
                  <div className="basis-1/4 hidden lg:flex lg:justify-end">
                     <div>
                        <div className="text-[#363636] flex gap-7 mb-7">
                           <img
                           ...
                           />
                           <div>
                              <span dangerouslySetInnerHTML={{ __html: service.point_contact || '' }} />
                              <span dangerouslySetInnerHTML={{ __html: service.designation ? ` (${service.designation})` : '' }} />
                           </div>
                        </div>
         ...
         <section className="pt-16 lg:pt-24 pb-10 lg:pb-40">
            <Container>
               <div className="mb-8 lg:mb-24">
                  ...
                  <p
                     className="text-[#4A4A4A] text-sm lg:text-base 2xl:text-[1.154rem]"
                     dangerouslySetInnerHTML={{ __html: service.services_provided || '' }}
                  />
               </div>
               <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-20 2xl:gap-24 gap-y-16'>
                  <div>
                     ...
                     <p
                        className="text-[#4A4A4A] text-sm lg:text-base 2xl:text-[1.154rem]"
                        dangerouslySetInnerHTML={{ __html: service.services_cost || '' }}
                     />
                  </div>
                  <div>
                     ...
                     <p
                        className="text-[#4A4A4A] text-sm lg:text-base 2xl:text-[1.154rem]"
                        dangerouslySetInnerHTML={{ __html: service.product_offered || '' }}
                     />
                  </div>
                  <div>
                     ...
                     <p
                        className="text-[#4A4A4A] text-sm lg:text-base 2xl:text-[1.154rem]"
                        dangerouslySetInnerHTML={{ __html: service.product_cost || '' }}
                     />
                  </div>
                  <div>
                     ...
                     <p
                        className="text-[#4A4A4A] text-sm lg:text-base 2xl:text-[1.154rem]"
                        dangerouslySetInnerHTML={{ __html: service.functional_expertise || '' }}
                     />
                  </div>
               </div>
            </Container>
