                  ...
                  <div className="flex flex-col lg:flex-row lg:items-end gap-10 lg:gap-24">
                     <div className="basis-1/4">
                        <div className="bg-white w-36 lg:w-64 aspect-square rounded-full p-3 lg:p-7 flex justify-center items-center">
                           <img src="/assets/img/tool-02.png" alt="Image" />
                        </div>
                     </div>
                     <div className="basis-2/4">
                        ...
                        <p className="text-[0.931rem] 2xl:text-[1.15rem] leading-relaxed hidden lg:block">Lorem Ipsum is simply dummy
            ...
            <section className="px-8 pt-16 lg:pt-24 pb-10 lg:pb-40">
               <div className="container mx-auto grid grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-20 2xl:gap-24 gap-y-16">
                  <div className="basis-1/5">
                     ...
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">Cost Structure</h2>
                  ...
                  <div className="basis-1/5">
                     ...
                     <hr className="border-secondary mt-5 mb-3" />
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">Fee Amount</h2>
                  ...
                  <div className="basis-1/5">
                     ...
                     <hr className="border-secondary mt-5 mb-3" />
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">Additional Comments
                     </h2>
                  ...
                  <div className="basis-1/5">
                     ...
                     <hr className="border-secondary mt-5 mb-3" />
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">Fee Credit</h2>
                  ...
                  <div className="basis-1/5">
                     ...
                     <hr className="border-secondary mt-5 mb-3" />
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">Support Structure</h2>
                  ...
                  <div className="basis-1/5">
                     ...
                     <hr className="border-secondary mt-5 mb-3" />
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">SDG Domain</h2>
                  ...
                  <div className="basis-1/5">
                     ...
                     <hr className="border-secondary mt-5 mb-3" />
                     <h2 className="text-secondary font-semibold text-[0.919rem] lg:text-lg 2xl:text-[1.309rem]">NGO References</h2>
