...
export default function Welcome() {
   return (
      <Layout>
         <Head title='Home' />
         <section
            className="grow lg:grow-0 flex flex-col lg:flex-row justify-center lg:justify-between items-center px-[5%] relative mt-auto"
         >
            <div className='absolute inset-0 bg-homeBg bg-no-repeat bg-[length:100%_auto] bg-[center_bottom] z-[-1] translate-y-8'></div>
