            ...
            >
               <div className="lg:basis-2/5 pt-10 md:pt-20 pb-10">
                  <div className="relative">
                     <h1 className="text-tertiary font-DMSerifDisplay text-[2.558rem] md:text-[3rem] leading-none">
                        Digital <br /><span
                  ...
                  <div className="flex justify-between gap-5">
                     <Link href={route('tools.index')} className="block text-center max-w-36 md:max-w-none">
                     ...
                     <Link href={route('services.index')} className="block text-center max-w-36 md:max-w-none">
